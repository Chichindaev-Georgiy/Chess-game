...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("""
               To test program use those commands:
               'exit' - leave game
               'replay' - retry game
               'castling0' или 'castling7' - castling on white and black sides
               'move 1 1 2 3' - to move figure from position 1 1 to 2 3 (chessboard is two dimensional array from 0 to 7)
               Check if figures can go through each other, can eat each other, can do check, perform castling""");
        System.out.println();
        board.printBoard();
        while (true) {
            ...
            if (s.equals("exit")) break;
                ...
                if (s.equals("castling0")) {
                    if (board.castling0()) {
                        System.out.println("Castling done successful");
                        board.printBoard();
                    } else {
